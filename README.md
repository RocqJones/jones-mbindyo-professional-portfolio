...
**Organization:** Equity Group  
**Role:** Mobile / Android Engineering
...
# 2. bolttech Kenya / mTek

**Industry:** Insurance / Insurtech  
**Platform:** Android  
**Organization:** Hillcroft Technologies / mTek  
**Current Product:** bolttech Kenya  
...
- Error handling
- User feedback
- Integration with the existing insurance workflow
...
- Data validation
- Appropriate handling of failed requests
- Maintainable application architecture
- Simple workflows for field users
...
# Core Expertise Demonstrated Across Projects

Across these projects, my experience covers several recurring technical and business challenges.
...
Experience delivering mobile products across:
...
Experience integrating mobile applications with:
...
Experience solving problems involving:
...
- Android AI benchmarking
- AI/OCR integration
- Evaluating AI-generated technical output
...
**Mobile:** Android, Jetpack Compose, Kotlin Multiplatform, SwiftUI

**Architecture:** Clean Architecture, MVVM, MVI

**Data & State:** Room, SQLDelight, Kotlin Flow, Coroutines
